...
#define BS21_PDM_BASE       0x5208E000   /* PDM (audio mic v150) */
...
static void bs21_machine_class_init(ObjectClass *oc, WS63_QOM_CLASS_DATA *data)
{
